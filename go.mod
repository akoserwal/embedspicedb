...
// Replace with local SpiceDB path for development
// When using this library, you'll need to add a similar replace directive
// pointing to your local SpiceDB repository
replace github.com/authzed/spicedb => ../spicedb
